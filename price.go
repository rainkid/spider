...
func (ti *Price) getItemCleanContent(item *Item) *Price {
...
func (ti *Price) getItemX(item *Item) *Price {
	htmlParser := NewHtmlParser()
...
func (ti *Price) getItemY(item *Item) *Price {
	htmlParser := NewHtmlParser()
...
func (ti *Price) GetItemPrice(item *Item) *Price {
	htmlParser := NewHtmlParser()
...
func (ti *Price) GetItemImg(item *Item) *Price {
	htmlParser := NewHtmlParser()
...
func (ti *Price) GetShopTitle(item *Item) *Price {
	htmlParser := NewHtmlParser()
...
func (ti *Price) CheckError(item *Item) bool {
	if item.err != nil {
		SpiderServer.qerror <- item
		return true
	}
